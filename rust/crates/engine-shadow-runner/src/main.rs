...
struct StyleSelectorV2 {
    ...
    nested_safety: Option<String>,
    composes: Option<Vec<serde_json::Value>>,
}
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
struct SelectorUsagePlanSummaryV0 {
    schema_version: &'static str,
    input_version: String,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
struct ExpressionSemanticsFragmentV0 {
    query_id: String,
    expression_id: String,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
struct ExpressionSemanticsFragmentsV0 {
    schema_version: &'static str,
    input_version: String,
...
fn summarize_selector_usage_plan_input(input: &EngineInputV2) -> SelectorUsagePlanSummaryV0 {
...
fn summarize_expression_semantics_fragments_input(
    input: &EngineInputV2,
