 ...
 *
 * Server wiring builds this once at startup; provider unit tests
 * build a stub via `makeBaseDeps()` in test helpers. Keeping this
 * a plain interface with no methods keeps provider tests trivial.
 */
